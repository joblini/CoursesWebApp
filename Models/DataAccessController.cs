...
namespace CoursesWebApp.Models
{
    ...
    {
        // Connection string
        private string connectionString = "Server=tcp:courseserver111.database.windows.net,1433;Initial Catalog=coursedatabase111;Persist Security Info=False;User ID=sqladmin;Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
